...
namespace BlazorFormManager
{
    internal static class InternalTypeExtensions
    {
        ...
        public static IEnumerable<SelectOption> OptionsFromEnumRange(this Type? type, string min, string max, bool useUnderlyingType = false)
        {
            ...
            static SelectOption NewOption(object id, string? value) => new() { Id = $"{id}", Value = value };
        }
        ...
        {
            result = default;
            return t.IsDateTime() && Microsoft.AspNetCore.Components.BindConverter.TryConvertToDateTime(value, culture, format, out result);
        }
        ...
        {
            result = default;
            return t.IsDateTimeOffset() && Microsoft.AspNetCore.Components.BindConverter.TryConvertToDateTimeOffset(value, culture, format, out result);
        }
    }
}
